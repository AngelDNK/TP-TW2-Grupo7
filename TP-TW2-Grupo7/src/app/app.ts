        ...
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center space-x-4">
            <ng-container *ngIf="authService.obtenerUsuarioLogueado(); else noLogueado">
              <a routerLink="/productos" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Productos</a>
              ...
              <a (click)="logout()" class="text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md text-sm font-medium cursor-pointer">Cerrar sesión</a>
            </ng-container>

            <ng-template #noLogueado>
              <a routerLink="/signin" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Iniciar sesión</a>
              <a routerLink="/signup" class="text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">Registrarse</a>
            </ng-template>
          </div>
        </div>
      </div>
